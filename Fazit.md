...
Ich habe mich schnell mit den gewählten Technologie (Angular, NestJs, etc.)
zurechtgefunden und kam so bei der Implementation gut voran.
Es war sehr spanned neuere Features von Angular, wie signals Signal-Forms 
